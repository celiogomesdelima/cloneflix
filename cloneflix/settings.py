"""
Django settings for cloneflix project.
...
WSGI_APPLICATION = 'cloneflix.wsgi.application'
...
DATABASE_URL = 'postgresql://postgres:lnwQCiowsPGkOjlmfDodDlXBNEdMYmwl@viaduct.proxy.rlwy.net:59799/railway'
if DATABASE_URL:
    DATABASES = {
